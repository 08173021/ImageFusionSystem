...
MODEL_SAVE_PATHS = [
    '/home/bingyang/wby/data/imagefusion_densefuse-master/models/densefuse_gray/densefuse_model_bs2_epoch4_all_weight_1e0.ckpt',
    '/home/bingyang/wby/data/imagefusion_densefuse-master/models/densefuse_gray/densefuse_model_bs2_epoch4_all_weight_1e1.ckpt',
    '/home/bingyang/wby/data/imagefusion_densefuse-master/models/densefuse_gray/densefuse_model_bs2_epoch4_all_weight_1e2.ckpt',
    '/home/bingyang/wby/data/imagefusion_densefuse-master/models/densefuse_gray/densefuse_model_bs2_epoch4_all_weight_1e3.ckpt',
]
	...
	if IS_TRAINING:
		...
		if IS_VIDEO:
			...
			for i in range(1):
				...
				# RGB images
				#infrared = path + 'children_1.tif'
				#visible = path + 'children_2.tif'
				infrared = '/home/bingyang/wby/1/1.png'
				visible = '/home/bingyang/wby/1/2.png'
